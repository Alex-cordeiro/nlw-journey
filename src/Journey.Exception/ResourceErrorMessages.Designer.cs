...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to A data da viagem não deve ser anterior a hoje!!!.
        /// </summary>
        public static string DATE_LATER_THAN_TODAY {
            get {
                return ResourceManager.GetString("DATE_LATER_THAN_TODAY", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Data não está de acordo com o período da viagem.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to A data de encerramento não pode ser menor que a data de inicio!!!.
        /// </summary>
        public static string END_DATE_LATER_START_DATE {
            get {
                return ResourceManager.GetString("END_DATE_LATER_START_DATE", resourceCulture);
            }
        }
